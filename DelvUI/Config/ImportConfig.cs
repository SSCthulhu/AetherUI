...
namespace DelvUI.Interface
{
    ...
    public class ImportConfig : PluginConfigObject
    {
        ...
        public bool Draw(ref bool changed)
        {
            ...
            ImGui.Text("Import profile snippets shared by the Aether UI community.");
        ...
        public (bool, bool) DrawImportConfirmationModal()
        {
            ...
            ImGui.OpenPopup("Import ##AetherUI");
            ...
            if (ImGui.BeginPopupModal("Import ##AetherUI", ref p_open, ImGuiWindowFlags.NoSavedSettings | ImGuiWindowFlags.AlwaysAutoResize | ImGuiWindowFlags.NoMove))
            {
                float width = 300;
