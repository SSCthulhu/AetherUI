...
namespace DelvUI.Interface
{
    public class HudManager : IDisposable
    {
        ...
        private PlayerParameterOrbHud _playerParameterOrbHud = null!;
        ...
        private void CreateUnitFrames()
        {
            ...
            var playerParameterOrbConfig = ConfigurationManager.Instance.GetConfigObject<PlayerParameterOrbConfig>();
            _playerParameterOrbHud = new PlayerParameterOrbHud(playerParameterOrbConfig, "Player Parameter Orb");
            _playerParameterOrbHud.ParentConfig = _playerUnitFrameHud.Config;
            _hudElements.Add(playerParameterOrbConfig, _playerParameterOrbHud);
            _hudElementsUsingPlayer.Add(_playerParameterOrbHud);
        ...
        private void CreateMiscElements()
        {
            ...
            var minimapConfig = ConfigurationManager.Instance.GetConfigObject<MinimapConfig>();
            var minimapHud = new MinimapHud(minimapConfig, "Minimap");
            _hudElements.Add(minimapConfig, minimapHud);
