...
namespace DelvUI.Interface.GeneralElements
{
    ...
    public class HUDOptionsConfig : PluginConfigObject
    {
        ...
        [Checkbox("Automatically disable HUD elements preview", help = "If enabled, all HUD elements preview modes are disabled when Aether UI settings are closed.")]
        [Order(11)]
        public bool AutomaticPreviewDisabling = true;

        [Checkbox("Use Aether UI style", help = "If enabled, Aether UI will use its own style for the settings window instead of the general Dalamud style.")]
        [Order(12)]
        ...
        [Checkbox("Automatic Mode", help =
            ...
            "When disabled: Aether UI unit frames will behave like the game's ones.\n" +
        ...
        //    "When enabled Aether UI will attempt to support special mouse binds (mousewheel, M4, M5, etc) when the cursor\n" +
        //    "is hovering on top of Aether UI unit frames.\n\n" +
        //    "If you don't have actions bound to these mouse buttons, it is adviced that you leave this feature disabled.\n\n" +
        //    "This feature can cause some issues such as click inputs not working in Aether UI, or throughout the game.\n" +
        //    "If you run into these kinds of issues, you can try reloading Aether UI, restarting the game, or disabling this feature.")]
        //[Order(17)]
        ...
        [Checkbox("Use Regional Number Format", help = "When enabled, Aether UI will use your system's regional format settings when showing numbers.\nWhen disabled, Aether UI will use English number formatting instead.", separator = true)]
        [Order(60)]
